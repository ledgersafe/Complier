...
class BusinessApp extends Component {
  ...
  render() {
    console.log("App rendering", this.state.name)
    return (
      <div className="App">
        <Header />
              ...
              <div class="container-fluid" id="main">
                <div>
                  <div class='row'>
                    ...
                    <div class='col-9'>
                    <BizLedger isOpen={this.state.collapsible} updateCollapsible={this.updateCollapsible} bid={this.state.name} ledger={this.state.ledger} style={{ color: '#69b5e5' }} updateSelectedAssetID={this.updateSelectedAssetID} />
                    </div>
                  </div>
                </div>
              </div>
